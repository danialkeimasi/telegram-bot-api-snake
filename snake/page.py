...
class Page:
    ...
    @property
    def markup(self):
        if self.botton_list + self.header_buttons + self.footer_buttons == []:
            return None
        ...
        if all([isinstance(i, InlineKeyboardButton) for i in self.botton_list + self.header_buttons + self.footer_buttons]):
